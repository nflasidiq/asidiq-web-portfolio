    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-5 flex flex-col gap-6">
          <div
            class="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-6 sm:p-7"
          >
            <h3 class="text-lg font-bold text-slate-100 mb-2">
              Direct Contact
            </h3>
            <p class="text-slate-400 text-sm mb-6 leading-relaxed">
              Feel free to reach out directly via email or connect on
              professional networks.
            </p>

            <!-- Copy Email Box -->
            <div
              class="flex items-center justify-between p-3.5 rounded-xl bg-slate-950 border border-slate-800/90 mb-4"
            >
